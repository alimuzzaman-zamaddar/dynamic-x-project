  ...
  return (
    <section className='lg:pt-18 pt-8'>
      <Container>
        ...
        <p className='text-[15px] font-normal text-[#1E2939] pt-4'>Carica il tuo file o contattaci per una consulenza tecnica gratuita. Analizziamo la tua geometria e ti proponiamo il materiale e la tecnologia più adatta.</p>
        <div className="flex md:flex-row flex-col gap-6 py-10">
          ...
          <div className="">
            ...
            <h5 className='text-[15px] font-normal text-black py-4'>Parla con i nostri tecnici per trovare la soluzione ottimale per la tua applicazione.</h5>
