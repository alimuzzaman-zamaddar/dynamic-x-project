  ...
  const materials = [
    {
      ...
      description:
        "Ideali per dispositivi a contatto diretto con cute e tessuti. Offrono elevata precisione dimensionale, superficie liscia e resistenza agli agenti chimici tipici dell'ambiente clinico. Certificate per uso medicale.",
      features: [
    ...
    },
    {
      title: "Nylon Tecnico",
      description:
        "Materiale termoplastico ad alte prestazioni, ideale per tutori e protesi che richiedono resistenza meccanica, flessibilità controllata e leggerezza strutturale. Eccellente per applicazioni funzionali a lungo termine.",
      features: [
    ...
    <section className="section bg-white text-primary-black font-family-inter">
      ...
      <div className="container-main">
        ...
        <div className="section-header mb-12">
          ...
          <h2 className="section-title">Materiali di Alta Qualità</h2>
          ...
          <p className="section-description text-primary-gray/80 mt-4 leading-6">
            La scelta del materiale è fondamentale per garantire sicurezza e
            durabilità in ambito clinico. Utilizziamo esclusivamente materiali
            testati e certificati per applicazioni medicali e veterinarie.
          </p>
        </div>
            ...
            <div key={index} className="flex flex-col gap-3">
              ...
              <ul className="flex flex-col gap-3 mt-2">
                {material.features.map((feature, featureIndex) => (
                  <li
                    key={featureIndex}
                    className="flex items-center gap-2 text-[15px] text-primary-black"
                  >
