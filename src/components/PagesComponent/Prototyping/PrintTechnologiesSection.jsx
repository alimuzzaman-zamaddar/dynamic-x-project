  ...
  const technologies = [
    {
      ...
      description: "Ideale per prototipi funzionali, parti meccaniche e test di assemblaggio. Ampia scelta di materiali tecnici: PLA, PETG, ABS, TPU. Costi contenuti e iterazione rapida, perfetto per le prime fasi di sviluppo e per geometrie robuste.",
      features: [
    ...
    },
    {
      ...
      description: "Risoluzione elevatissima per dettagli fini, superfici lisce e mockup estetici di alta qualità. Perfetto per presentazioni al cliente, parti ottiche e componenti che richiedano tolleranze strette e finitura superficiale impeccabile.",
      features: [
      ...
      <div className="container-main">
        ...
        <div className="section-header mb-12">
          ...
          <p className="section-description ">
            Utilizziamo le tecnologie più adatte a ogni fase del processo di sviluppo prodotto. La scelta della macchina giusta fa la differenza tra un prototipo utile e uno che rallenta il progetto.
          </p>
        </div>
        ...
        <div className="relative mt-10">
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-0.5 text-black/80 font-medium">
            ...
            <div className="flex flex-col gap-6 p-10 xl:p-12 md:bg-[#1C1C24] rounded-sm">
              ...
              <ul className="flex flex-col gap-3 mt-4 text-[12px] leading-[22px] text-white">
            ...
            <div className="flex flex-col gap-6 p-10 xl:p-12">
              ...
              <ul className="flex flex-col gap-3 text-[12px] leading-3 ">
