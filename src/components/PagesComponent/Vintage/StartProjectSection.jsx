    ...
    <section className="section bg-white">
      <div className="container-main flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="section-title text-black">Inizia il Tuo Progetto</h2>
          <p className="text-[15px] leading-[22px] text-black/80 max-w-[900px]">
            Hai un pezzo introvabile? Un restauro bloccato per mancanza di un
            componente? Contattaci con una foto e una breve descrizione del
            pezzo originale. Il nostro team tecnico valuterà la fattibilità e ti
            proporrà la soluzione più adatta — materiale, tecnologia e tempi di
            consegna inclusi.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 bg-[#E8E8F0] p-6 w-full">
          ...
          <p className="text-[15px] leading-[22px] text-black/80">
            Ogni consulenza iniziale è gratuita e senza impegno. Portiamo la
            storia della tua automobile nel futuro, un componente alla volta.
          </p>
        </div>
