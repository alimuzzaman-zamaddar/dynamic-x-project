  ...
  return (
    <section className='lg:py-18 py-8'>
      <Container>
        ...
        <p className='text-[15px] font-normal text-[#1E2939] pt-4'>Il nuovo catalogo che rivoluzionerà il tuo modo di progettare e stampare in 3D. Stiamo creando qualcosa di straordinario, in arrivo a breve.</p>
