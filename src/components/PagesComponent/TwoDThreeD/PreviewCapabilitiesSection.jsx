  ...
  const capabilities = [
    {
      ...
      description: "Trasforma un semplice logo o marchio in un gadget unico e professionale. Perfetto per il merchandising aziendale."
    },
    {
      title: "Arte in 3D",
      description: "Dai vita ai tuoi disegni artistici. Ogni illustrazione può diventare un oggetto tridimensionale da toccare e ammirare."
    },
    {
      title: "Prototipazione Rapida",
      description: "Parti da un disegno tecnico 2D e ottieni un prototipo fisico in tempi record. Ideale per ingegneri e designer."
    }
  ];
          ...
          {capabilities.map((capability, index) => (
            ...
            <div key={index} className="flex gap-4 text-left items-start">
              ...
              <div className="flex flex-col gap-3 pt-0.5">
                ...
                <p className="text-primary-black/80 text-[12px] leading-[22px] ">
