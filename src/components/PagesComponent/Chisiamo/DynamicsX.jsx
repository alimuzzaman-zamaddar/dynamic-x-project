  ...
  return (
    <section className='lg:py-18 py-8'>
      <Container>
        ...
        <p className='text-[15px] font-normal  text-[#1E2939] pt-4'>DynamicsX produce componenti personalizzati ad alta precisione per droni, automotive d'epoca, veterinaria e industria specializzata. Utilizziamo tecnologie FDM, SLA e SLS per consegnare prototipi in 48 ore e serie produttive in 5–10 giorni lavorativi. Nessun ordine minimo, nessun compromesso sulla qualità.</p>
